...
import iconBillTemplate from './assets/icon_bill_template.png'
import iconTermDictionary from './assets/icon_term_dictionary.png'
...
.right-sidebar {
  ...
  height: 100%;
  background: url('./assets/bg_right_sidebar.png') no-repeat;
