          ...
          <div class="task-screen-border">
            <div class="mission-overlay-bg">
              ...
              <header class="mission-header">
                <img src="../assets/img/icon_task_card.png" class="header-icon" />
              ...
              <div class="action-guide">
                <img src="../assets/img/icon_next_step.png" class="guide-icon" />
  ...
  .task-board {
    ...
    .task-screen-border {
      ...
      .mission-overlay-bg {
        ...
        background: url('../../assets/img/bg_story_overlay.png') no-repeat center;
