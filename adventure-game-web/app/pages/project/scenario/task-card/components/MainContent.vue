...
import { ref } from 'vue'
import ScenarioSectionLayout from '../../components/ScenarioSectionLayout.vue'
import ScenarioTimeline from '../../components/ScenarioTimeline.vue'

// 引入本页面特有资源
import imgTaskScene from '../assets/img/img_task_scene_alt.png'
import bgStoryOverlay from '../assets/img/bg_story_overlay.png'
...
.scene-box-container {
  ...
  .scene-main-frame {
    ...
    width: 100%;
    height: 100%;
    background: url('@/assets/img/bg_story_content.png') no-repeat;
